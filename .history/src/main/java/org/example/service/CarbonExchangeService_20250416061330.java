...
public class CarbonExchangeService {
    ...
    public String addLiquidity(Map<String, String> request) {
        try {
            ...
            // 更新流動性提供者
            LiquidityProviderId providerId = new LiquidityProviderId(exchange.getId(), userId);
    ...
    public LiquidityPool getLiquidityPool() {
        return liquidityPoolRepository.findById(1L)
    ...
    public Map<String, BigDecimal> getLiquidityInfo() {
        ...
        info.put("cctReserves", pool.getCctReserves());
        info.put("usdcReserves", pool.getUsdcReserves());
        return info;
    }
