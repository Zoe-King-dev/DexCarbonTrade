...
public class CarbonExchange {
    ...
    public BigDecimal getBaseBalance(String address) {
        ...
        System.out.println("DEBUG: Database connection info:");
        System.out.println("DEBUG: - Database URL: jdbc:mysql://localhost:3306/carbon_trade");
        System.out.println("DEBUG: - Table: usdc_balances");
        System.out.println("DEBUG: - Query: SELECT balance FROM usdc_balances WHERE address = '" + address + "'");
        
        System.out.println("DEBUG: Current baseBalances list state:");
