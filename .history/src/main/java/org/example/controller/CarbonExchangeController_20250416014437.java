...
public class CarbonExchangeController {
    ...
    public ResponseEntity<Map<String, Object>> getPoolStatus() {
        CarbonExchange exchange = exchangeService.getExchange();
        Map<String, Object> response = new HashMap<>();
        response.put("isEmpty", exchange.getCarbonCreditReserves().equals(BigDecimal.ZERO) && 
                              exchange.getBaseCurrencyReserves().equals(BigDecimal.ZERO));
